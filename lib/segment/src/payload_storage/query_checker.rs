...
use crate::types::{Filter, PayloadKeyType, PayloadType, Condition, GeoBoundingBox, Range, Match, TheMap, PointOffsetType};
...
mod tests {
    ...
    fn test_condition_checker() {
        ...
        let mut payload_storage = SimplePayloadStorage::open(dir.path());
        let mut id_mapper = SimpleIdMapper::open(dir_id_mapper.path());
